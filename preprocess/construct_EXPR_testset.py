...
video_frames_dict = {}
with open("/data3/zww/abaw/testset/test_set_examples/CVPR_6th_ABAW_Expr_test_set_example.txt","r") as f:
    lines = f.readlines()
    for line in lines[1:]:
        t = line.split("/")[0]
...
for video_file in tqdm(video_files):
    ...
    # 读取图片特征
    img_mae_feature_dir = os.path.join(
        mae_dir, video_file.split(".")[0])
